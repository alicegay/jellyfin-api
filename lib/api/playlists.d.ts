...
export declare const add: (client: Client, playlistID: string, itemIDs: string[]) => Promise<unknown>;
export declare const remove: (client: Client, playlistID: string, itemIDs: string[]) => Promise<unknown>;
export declare const create: (client: Client, name: string, itemIDs: string[], isPublic: boolean) => Promise<unknown>;
